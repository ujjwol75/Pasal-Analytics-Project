import { addRule, getUsers, updateRule } from '@/services/ant-design-pro/api';
  ...
  const columns: ProColumns<TableListItem>[] = [
    {
      ...
      width: 20,
      render: (text: any) => {
        // const href = `/user/${text.props.text}`;
        const href = `/user/edit/${text}`;
        ...
        <FooterToolbar
          extra={
            <div>
              ...
              <FormattedMessage id="pages.user.name" defaultMessage="Users" />
              &nbsp;&nbsp;
            </div>
          }
        >
