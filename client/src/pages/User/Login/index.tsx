...
const Login: React.FC = () => {
  ...
  const handleSubmit = async (values: API.LoginParams) => {
    try {
      ...
      asyncLocalStorage
        .setItem('auth', JSON.stringify(msg))
        .then(function () {
          return asyncLocalStorage.getItem('auth');
        })
        .then(function () {
          console.log('Value has been set to new auth');
        });
      if (msg.status === 'ok') {
    ...
    <div className={containerClassName}>
      ...
      >
        <LoginForm
          ...
          logo={
            <img
            style={{height:"40px",width:"150px",marginLeft:"-50px"}}
          ...
          subTitle={
              <div style={{marginTop:"20px",fontSize:"40px",fontWeight:"bold",color:"black"}}>
                Pasal Analytics
              </div>
            }
          initialValues={{
